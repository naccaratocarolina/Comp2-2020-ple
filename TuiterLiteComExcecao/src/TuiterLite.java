...
public class TuiterLite<T> {
     ...
     */
    public Usuario cadastrarUsuario(String nome, String email) throws EmailComFormatoIncorretoException {
     ...
     * @throws UsuarioNaoCadastradoException Excecao para verificar se um usuario eh cadastrado na plataforma
     * @throws TamanhoMaximoDoTuiteExcedidoException Excecao para garantir que o tuite nao exceda o tamanho maximo permitido
     */
    public Tuite tuitarAlgo(Usuario usuario, String texto)
        ...
        if(!this.verificaSeUsuarioEhCadastrado(usuario)) throw new UsuarioNaoCadastradoException();
        if(texto.length() > TAMANHO_MAXIMO_TUITES) throw new TamanhoMaximoDoTuiteExcedidoException();
