...
public class TuiterLiteTest {
    ...
    @Before
    public void setUp() throws EmailComFormatoIncorretoException {
        // cria um TuiterLite
    ...
    @Test
    public void testeUsuariosReconhecidosCorretamente()  throws EmailComFormatoIncorretoException {
    ...
    public void testeAutorDoTuite()
            throws UsuarioNaoCadastradoException, TamanhoMaximoDoTuiteExcedidoException {
    ...
    @Test
    public void testeTuiteDeUsuarioDesconhecido()  throws EmailComFormatoIncorretoException {
        try {
    ...
    public void testeApenasUmTipoPermitidoComoAnexo()
            throws UsuarioNaoCadastradoException, TamanhoMaximoDoTuiteExcedidoException,
            EmailComFormatoIncorretoException {
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    /////
    @Test
    public void testePerformanceTuites()  throws EmailComFormatoIncorretoException {
        try {
    ...
    @Test
    public void testeEmailNoFormatoIncorreto() {
        try{
            //Tenta cadastrar um usuario com email invalido
            tuiterLite.cadastrarUsuario("Fulano", "fulano");
    ...
    @Test
    public void testeTamanhoTuiteExcedido() throws UsuarioNaoCadastradoException {
        try {
            testeTamanhoTuite();
        } catch (TamanhoMaximoDoTuiteExcedidoException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    public void testeUsuarioNaoCadastrado()
            throws TamanhoMaximoDoTuiteExcedidoException, EmailComFormatoIncorretoException {
        try {
            Usuario usuarioDesconhecido = new Usuario("Usuário Desconhecido", "unknown@void.com");
            //Tenta tuitar algo com um usuario nao cadastrado na plataforma
            tuiterLite.tuitarAlgo(usuarioDesconhecido, "Texto do tuite.");
